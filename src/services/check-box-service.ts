...
export class CheckBoxService implements IService {
    ...
    getDataForLayout3 = (): any => {
        return [
              {"id" : 1, "title" : 'Song', "icon" : 'icon-music-box'},
              {"id" : 2, "title" : 'Album', "icon" : 'icon-music-box'},
              {"id" : 3, "title" : 'Artist', "icon" : 'icon-music-box'},
              {"id" : 4, "title" : 'Song', "icon" : 'icon-music-box'},
              {"id" : 5, "title" : 'Album', "icon" : 'icon-music-box'},
              {"id" : 6, "title" : 'Artist', "icon" : 'icon-music-box'}
          ];
    }
